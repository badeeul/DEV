...
# ## Notebook Overview
# 
# Please refer to the [README file](https://dev.azure.com/BHGDataAndAnalytics/DnA%20Pdt%20and%20Prc/_git/DnA%20Pdt%20and%20Prc%20-%20Comn%20Pdt%20Lyr?path=%2Fdocs%2Fpolicy_dp%2Ffabric%2Fdataset_query_file_management.md&version=GBmain&_a=contents) for detailed instructions and information
    ...
    try:
        ...
        for item in items:
            if item.isDir:
                ...
                logger.debug(f"Added file: filePath={item.path}")
...
def main():
    ...
    try:
        ...
        top_rows = None # 1000 limit on dataset TOP rows or None
        ...
        for item in contents:
            source_config_folder_name = item['filePath'].rsplit('/', 1)[0] + '/'
