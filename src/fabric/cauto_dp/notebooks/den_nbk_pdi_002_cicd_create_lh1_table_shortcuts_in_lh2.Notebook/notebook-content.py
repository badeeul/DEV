...
shortcuts = [
{
  ...
  {
    "name": "dim_policy_status",
    "path": "/Tables/cauto",
    "target": {
      "type": "OneLake",
      "oneLake": {
        "path": "Tables/policy/dim_policy_status",
        "itemId": "00000000-0000-0000-0000-000000000000",
        "workspaceId": "00000000-0000-0000-0000-000000000000"
      }
    }
  },
  {
    ...
    "target": {
      "type": "OneLake",
      "oneLake": {
        "path": "Tables/policy/dim_insured",
        "itemId": "00000000-0000-0000-0000-000000000000",
        "workspaceId": "00000000-0000-0000-0000-000000000000"
      }
    }
  ...
  {
    "name": "dim_insured_legal_entity_type",
    "path": "/Tables/cauto",
    "target": {
      "type": "OneLake",
      "oneLake": {
        "path": "Tables/policy/dim_insured_legal_entity_type",
        "itemId": "00000000-0000-0000-0000-000000000000",
        "workspaceId": "00000000-0000-0000-0000-000000000000"
      }
    }
  },
  {
    ...
    "target": {
      "type": "OneLake",
      "oneLake": {
        "path": "Tables/policy/dim_lob_product",
        "itemId": "00000000-0000-0000-0000-000000000000",
        "workspaceId": "00000000-0000-0000-0000-000000000000"
      }
    }
  ...
  },
  {
    ...
    "target": {
      "type": "OneLake",
      "oneLake": {
        "path": "Tables/policy/fact_policy",
        "itemId": "00000000-0000-0000-0000-000000000000",
        "workspaceId": "00000000-0000-0000-0000-000000000000"
      }
    }
  ...
  {
    "name": "dim_vehicle_deleted_on_date",
    "path": "/Tables/cauto",
    "target": {
      "type": "OneLake",
      "oneLake": {
